          ...
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-center space-x-4 mt-6">
                <div className="flex items-center space-x-2 px-4 py-2 bg-slate-800/80 backdrop-blur-sm rounded-lg border border-slate-600">
            ...
            <button
              ...
              className="px-8 py-4 bg-white hover:bg-gray-100 text-black font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              View Clips
            </button>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <main className="container mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Your epic gaming moments</p>
        </div>
        ...
        {mockVideos.length > 0 ? (
          ...
          <div className="flex items-center justify-center py-20">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-500">Upload your first clip to get started!</p>
            </div>
          </div>
        )}
      </main>
